...
#define SAVER_Y_MIN  80

/* Przewijanie  */                            /* {{ left, top, fontsize, align }, buffsize, uppercase, width, scrolldelay, scrolldelta, scrolltime } */
...
inline WidgetConfig getclockConf() {
  switch (config.store.vuLayout) {
    ...
    default: return { TFT_FRAMEWDT+70, 177, 52, WA_RIGHT };  //187{ TFT_FRAMEWDT+70, 167, 52, WA_RIGHT };
  }
}
...
static constexpr ScrollConfig kDateBase = {
    { TFT_FRAMEWDT, 186, 5, WA_RIGHT }, 128, false, 220, 5000, 3, 35 };  //    { TFT_FRAMEWDT, 186, 5, WA_RIGHT }, 128, false, 220, 5000, 3, 35 };

static inline uint16_t dateTopByLayout(uint8_t ly) {
  switch (ly) { case 1: case 2: case 3: return 160; default: return 185; }  //160 /170
}
